          ...
          <div class="container-fluid ps-2 pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="#/product/material-dashboard" class="btn btn-sm mb-0 me-1 bg-gradient-dark">Free download</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="#" class="font-weight-bold text-white" target="_blank">Shop</a>
                Laptop
              </div>
            </div>
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="#" class="nav-link text-white" target="_blank">Shop Laptop</a>
                </li>
                <li class="nav-item">
