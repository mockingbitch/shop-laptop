                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="danhmuc_id">
                        @foreach($tatcadanhmuc as $danhmuc)
                            <option value="{{$danhmuc->id}}" {{$sanpham->danhmuc_id == $danhmuc->id ? 'selected' : ''}}>{{$danhmuc->ten}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" name="thuonghieu_id" id="">
                        @foreach($tatcathuonghieu as $thuonghieu)
                            <option value="{{$thuonghieu->id}}" {{$sanpham->thuonghieu_id == $thuonghieu->id ? 'selected' : ''}}>{{$thuonghieu->ten}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
